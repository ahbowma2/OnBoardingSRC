...
public class InternetExplorerTests {
	...
	*/
	...
	public void startClassIE() {
		System.out.println("Starting Internet Explorer Class");
	...
	@Test
	public void Test1IE() throws Exception {
		Nav.NavToBase("");
		...
		Base.Screenshot("DeptAddEvidenceIE");
		...
		Base.Screenshot("EmpEditEvidenceIE");
