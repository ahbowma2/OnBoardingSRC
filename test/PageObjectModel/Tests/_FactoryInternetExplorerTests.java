...
public class _FactoryInternetExplorerTests {
	/*
	...
	*/
	...
	@BeforeClass()
	public void startClassIE() {
		System.out.println("Starting Internet Explorer Factory Class");

	}

	@AfterClass()
	public void endClassIE() {
		System.out.println("Ending Internet Explorer Class");
		System.out.println("================================================================");
	}
	/*
	...
	*/
	...
	public void start() {
		...
		_driver = test.PageObjectModel.Pages.BasePage.GetIEDriver();
	...
	*/
	...
	/*-
	 	Here I run the test for IE using page object model.
	KEY:****************************************************************************************************
	...
	*/
	@Test
	public void FactoryTest1IE() throws Exception {
		Navigate.NavToBase("");
