...
public class _FactoryGoogleChromeTests {
	/*
	...
	*/
	...
	public void startClassGC() {
		System.out.println("Starting Google Chrome Factory Class");

	}

	@AfterClass()
	public void endClassGC() {
		System.out.println("Ending Google Chrome Class");
		System.out.println("================================================================");
	}
	...
	*/
	@Test
	public void FactoryTest1GC() throws Exception {
		Navigate.NavToBase("");
		...
		Base.Screenshot("FactoryDeptAddEvidenceGC");
